...
$(document).ready( function () {
  ...
  $('.header__fixed-auth').on('click', function() {

    $('.header__fixed-dropdown').toggleClass('drop-auth');
...
(function(){
  ...
  $('.navigation-mobile__hamburger').on('click', function() {
    $('.navigation-mobile__list-container').addClass('drop-navigation-mobile');
    $('body').css({
      overflow: 'hidden'
    });
  });

  $('.navigation-mobile__close').on('click', function() {
    $('.navigation-mobile__list-container').removeClass('drop-navigation-mobile');
    $('.navigation-mobile__list-item-dropdown__navigation-mobile').removeClass('drop-submenu');
    $('body').css({
      overflow: 'auto'
    });
  });

  $('.navigation-mobile__list-item-title').on('click', function() {
    $(this).next().toggleClass('drop-submenu');
  })
...
function showSlides(n) {
    var i;
    var slides = document.getElementsByClassName("cart-item__block-modal-content-item");
    var dots = document.getElementsByClassName("cart-item__block-modal-column-thumb-img");
